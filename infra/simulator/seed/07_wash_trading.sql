...
VALUES
    (300, 11, 1, 1, 'venta',  500, 120.00, 60000.00, '2025-01-15 10:00:00+00', '2025-01-15', 'ejecutada'),
    (301, 12, 1, 1, 'compra', 500, 120.00, 60000.00, '2025-01-15 10:00:45+00', '2025-01-15', 'ejecutada')
...
INSERT INTO broker.transacciones
    (folio, contrato_id, valor_id, trader_id, sentido, titulos, precio_ejec, importe, fecha_hora, fecha_op, estatus)
VALUES
    (302, 11, 2, 1, 'venta',  300, 200.00, 60000.00, '2025-01-15 11:00:00+00', '2025-01-15', 'ejecutada'),
    (303, 12, 2, 2, 'compra', 300, 200.00, 60000.00, '2025-01-15 11:02:00+00', '2025-01-15', 'ejecutada')
ON CONFLICT (folio) DO NOTHING;
...
INSERT INTO broker.transacciones
    (folio, contrato_id, valor_id, trader_id, sentido, titulos, precio_ejec, importe, fecha_hora, fecha_op, estatus)
VALUES
    (304, 16, 3, 1, 'venta',  1000, 150.00, 150000.00, '2025-01-15 12:00:00+00', '2025-01-15', 'ejecutada'),
    (305, 17, 3, 2, 'compra',  980, 150.50, 147490.00, '2025-01-15 12:01:30+00', '2025-01-15', 'ejecutada')
ON CONFLICT (folio) DO NOTHING;
